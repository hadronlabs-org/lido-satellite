...
echo
echo "Rainy day scenario: mint 100 wATOM, swap 0 wATOM for IBC fee, initiate transfer of 100 wATOM to Gaia"
msg="$(printf '{
  "wrap_and_send": {
    "source_port": "transfer",
    "source_channel": "channel-0",
...
echo
echo "Rainy day scenario: mint 700 wATOM, swap 600 wATOM for wrong IBC fee, initiate transfer of 100 wATOM to Gaia"
msg="$(printf '{
  "wrap_and_send": {
    "source_port": "transfer",
    "source_channel": "channel-0",
